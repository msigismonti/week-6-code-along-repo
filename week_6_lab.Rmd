...
Let's make an exploratory scatterplot of penguin flipper length versus body mass (here, we will *only* use those variables - keeping in mind as we move forward that we probably also want to include species and sex as variables in our model...).
